function performCalculation(num1, num2, operationIndex,) {
...
beforeEach(() => {
    ...
    performCalculation ('5','5', 0);  // paprasta sudėtis
    performCalculation ('-15','-15', 0); // sudėtis su minusu
    performCalculation ('0','0', 0,); // nulių sudėtis
    ...
    performCalculation ('5','5', 1, '0');  // paprasta atimtis
    ...
    performCalculation ('7','7', 3, '1');  // paprasta dalyba
...
///// Rastos klaidos - pirmas skaičius imamas iš answer, o ne iš First number